...
- **gpt-oss-120b & Dedicated (Pflicht):** **gpt-oss-120b** ist auf **Shared AI Hosting** (Starter/Pro/Business) über die **API** nutzbar — dafür **kein** Dedicated nötig. Frage „passt das größte Modell auf Dedicated M?“ → zuerst klären: **API-Nutzung** (Shared reicht) vs. **eigene GPU** (Dedicated). Für **eigene** GPU auf M grob bis ca. **30B–70B** (Orientierung) — **120B** eher **L/XL** mit Sharding; trotzdem **96 GB** VRAM auf M nennen, nicht 48 GB.
