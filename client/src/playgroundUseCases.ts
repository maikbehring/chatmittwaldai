...
- **Dedicated Monitoring (Pflicht):** Frage „Auslastung überwachen“ / „Dashboard“ bei **Dedicated** → **Nicht** mStudio-Live-Dashboard/Logs/Token-Statistiken versprechen. **Richtig:** Wir betreiben Dedicated und melden uns bei **erhöhter Auslastung**; im **mStudio** nur **Tarifverwaltung** (keine Dedicated-Token-Statistiken aktuell). **Optional:** **Grafana-Dashboard** auf Wunsch über **Vertrieb** (+49 5772 293 150). Shared-Token-Hinweise aus mStudio **nicht** auf Dedicated übertragen.
