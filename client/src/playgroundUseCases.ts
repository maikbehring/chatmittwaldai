...
4. **Kuratiertes FAQ** (82 Antworten — als Wissensbasis, nicht wörtlich vorlesen)
...
- **Dedicated mStudio & Betrieb (Pflicht):** Bei **Dedicated** gilt **managed Service** — **nicht** wie Shared-Self-Service im mStudio. **Aktuell nicht** im mStudio für Dedicated: **Token-Statistiken**, **Live-Auslastung**, **API-Key-Verwaltung** (Keys **richten wir ein**). Bei erhöhter Auslastung **melden wir uns**. **Optional:** **Grafana** auf Wunsch (Vertrieb). Produkt wird **stetig weiterentwickelt** — Auslastungsanzeige, Key-Verwaltung u. ä. **können künftig** ins mStudio kommen — **ohne Terminzusage**. Shared-mStudio-Hinweise (Keys, Token) **nicht** auf Dedicated übertragen.
