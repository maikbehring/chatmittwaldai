...
export const PLAYGROUND_AI_HOSTING_TARIFF_FAQ: TariffFaqEntry[] = [
  ...
  },
  {
    ...
    answer: "**Kurz:** Dedicated ist ein **managed Service** — wir betreiben und richten vieles **für dich ein**. Im mStudio ist Dedicated **aktuell nicht** wie Shared selbst bedienbar.\n\n**So läuft es heute:**\n\n- **Betrieb & Auslastung:** Wir kümmern uns darum, dass alles sauber läuft. Bei **erhöhter Auslastung** melden wir uns **proaktiv** bei dir.\n- **mStudio:** **Keine** Token-Statistiken und **kein** Live-Auslastungs-Dashboard für Dedicated. **API-Keys** kannst du bei Dedicated **aktuell auch nicht** im mStudio verwalten — **wir richten die Keys für dich ein** (über den Vertrieb).\n- **Grafana (optional):** Auf Wunsch stellen wir ein **dediziertes Grafana-Dashboard** bereit — Anfrage: **+49 5772 293 150**.\n\n**Weiterentwicklung:** Das Produkt entwickeln wir **stetig** weiter. Themen wie **Auslastungsanzeige**, **Key-Verwaltung** im mStudio und ähnliche Self-Service-Funktionen **können künftig** dazukommen — **ohne** feste Terminzusage.\n\n**Nicht verwechseln:** Token-Verbrauch, API-Keys und Hinweise im mStudio bei **Shared** (Starter/Pro/Business) gelten **nicht** 1:1 für Dedicated.\n\n**Merksatz:** Dedicated = managed durch mittwald · Shared = Self-Service im mStudio.",
  },
  {
    id: 81,
    section: "Integration",
