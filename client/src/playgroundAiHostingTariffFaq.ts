...
export const PLAYGROUND_AI_HOSTING_TARIFF_FAQ: TariffFaqEntry[] = [
  ...
  },
  {
    id: 76,
    section: "Tarifwahl",
    question: "Wie viel VRAM hat Dedicated AI M — und passt gpt-oss-120b darauf?",
    answer: "**Dedicated AI M** = **1× RTX 6000 PRO** mit **96 GB VRAM gesamt** — **nicht** 48 GB. Davon sind ca. **62 GB** für das Modell selbst eingeplant (ca. 35 % für Context Caching reserviert).\n\n**Wichtig unterscheiden:**\n\n1. **gpt-oss-120b über die API (Shared)** — Das Modell ist auf **Shared AI Hosting** (Starter/Pro/Business) in der **Live-Modellliste** nutzbar. Dafür brauchst du **kein** Dedicated — nur einen passenden Shared-Tarif + API-Key.\n\n2. **Eigene GPU (Dedicated)** — Wenn du ein Modell **auf deiner dedizierten GPU** betreiben willst: Dedicated M ist grob für Modelle bis ca. **30B–70B** (je nach Quantisierung) ausgelegt. **120B** auf **einer** GPU in M ist in der Regel **zu groß** → eher **Dedicated L/XL** mit Model-Sharding/Load Balancing mit dem **Vertrieb** klären.\n\n**Merksatz:** VRAM **gesamt** auf M = **96 GB**. Modellgrößen-Orientierung ≠ API-Verfügbarkeit auf Shared.",
  },
  {
    id: 56,
    section: "Tarifwahl",
