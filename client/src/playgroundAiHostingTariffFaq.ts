...
export const PLAYGROUND_AI_HOSTING_TARIFF_FAQ: TariffFaqEntry[] = [
  ...
  },
  {
    ...
    answer: "**Ja — auf Dedicated AI Hosting ist das grundsätzlich möglich.**\n\n**Shared vs. Dedicated:**\n\n- **Shared** (Starter/Pro/Business): Du nutzt die Modelle aus unserer **Live-Modellliste** (`/v1/models`). Steht ein Modell dort nicht, ist es auf Shared **nicht** buchbar.\n- **Dedicated AI Hosting:** Hier können wir **eigene oder kundenspezifische Modelle** einrichten — auch solche, die wir im **klassischen AI Hosting** (noch) **nicht** im Standard-Katalog anbieten.\n\n**So läuft es ab:**\n\n1. **Modellwunsch** mit dem **Vertrieb** besprechen (+49 5772 293 150)\n2. Wir **prüfen**, ob das Modell auf unserer Infrastruktur (RTX 6000 PRO, Hosting in Deutschland) **technisch funktioniert**\n3. Passt es → wir **richten es ein** und stellen die **OpenAI-kompatible API** bereit\n\n**Kosten-Hinweis:** Einmalige Einrichtung für **kundenspezifische / spezielle Modelle**: **199 €** (laut Dedicated-Erweiterungen). GPU-Stufe (M/L/XL) hängt vom Modell ab.\n\n**Merksatz:** „Nur Live-Liste“ gilt für **Shared** — bei **Dedicated** nicht pauschal ablehnen, sondern Machbarkeit mit dem Vertrieb klären.",
  },
  {
    id: 78,
    section: "Modelle",
