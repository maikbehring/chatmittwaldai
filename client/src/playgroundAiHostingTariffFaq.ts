...
export const PLAYGROUND_AI_HOSTING_TARIFF_FAQ: TariffFaqEntry[] = [
  ...
  },
  {
    ...
    answer: "**Kurz:** Kein AI Hosting — typisch **Webhosting** + **vServer/Container** + **E-Mail** im **mStudio**.\n\n**Zuordnung (intern):** Website→Webhosting · E-Mail→im Paket/mStudio · Cloud→Nextcloud auf vServer/Container · Aufgabenboard→Container-Vorlage.\n\n**So antwortest du dem Kunden (Muster — persönlich formulieren, nicht abschreiben):**\n\n„Für dein Ehrenamt brauchst du im Grunde drei Bausteine: **Webhosting** für die Vereinswebsite (z. B. WordPress) — E-Mail-Adressen legst du im **mStudio** an, die sind im Hosting-Paket mit drin. Für **Dokumente in der Cloud** und ein **Aufgabenboard** eignet sich ein **vServer** mit **Container Hosting** — dort startest du z. B. Nextcloud und eine Kanban-Vorlage per Klick.\n\nHosting läuft in Deutschland (DSGVO) — jeder kann bei uns buchen, auch Vereine.\n\n**Nächste Schritte:** Erst [Webhosting](https://www.mittwald.de/webhosting) wählen, dann im [mStudio](https://mstudio.mittwald.de/) anlegen und für Cloud/Board [Container Hosting](https://www.mittwald.de/mstudio/container-hosting) auf einem [vServer](https://www.mittwald.de/vserver) planen.“\n\n**Verboten in der Kundenantwort:** Produktkatalog abschreiben, 8+ Links, AI Hosting, n8n, Dedicated ungefragt.",
  },
  {
    id: 82,
    section: "Integration",
    question: "Frage hat nichts mit AI Hosting zu tun — was soll der Tarifberater antworten?",
    answer: "**Grundsatz:** Bei Fragen **ohne KI-Bezug** **beratend** helfen — **nicht** den Mittwald-Kurzprofil-Block oder eine Link-Liste ausgeben.\n\n**Antwort-Stil:** Jede **Anforderung** des Nutzers einzeln zuordnen · Fließtext oder max. 4 Punkte · max. 3 Links am Ende · **kein** AI Hosting ungefragt.\n\n**Zuordnung (intern):** Website→Webhosting · E-Mail→mStudio/Paket · Cloud/Apps→vServer/Container · KI→AI Hosting.\n\n**Wenn du nicht weiterkommst:** https://www.mittwald.de oder Vertrieb +49 5772 293 150.",
  },
  {
    id: 83,
    section: "Integration",
  ...
  },
  {
    ...
    answer: "**Kurz:** Bei **„Ja, legen wir los“** nach Hosting-Beratung — **nummerierte Schritte**, **keine** Link-Flut.\n\n**Muster-Antwort:**\n\n1. **Webhosting** buchen für die Website — https://www.mittwald.de/webhosting\n2. Kostenlos im **mStudio** anlegen und Projekt einrichten — https://mstudio.mittwald.de/\n3. **E-Mail-Adressen** im Projekt anlegen (im Paket enthalten)\n4. Für **Cloud + Aufgabenboard:** **vServer** + **Container Hosting** mit Nextcloud/Kanban-Vorlage — https://www.mittwald.de/vserver · https://www.mittwald.de/mstudio/container-hosting\n\n**Verboten:** AI-Hosting-Tarifseite, API-Key, alle Produktlinks als Block, Produktkatalog abschreiben.",
  },
  {
    id: 56,
    section: "Tarifwahl",
