...
const DEFAULT_FALLBACK_CHAINS: Record<string, string[]> = {
  [MODEL_QWEN_38]: [MODEL_QWEN_36, MODEL_QWEN_35, MODEL_MINISTRAL, MODEL_GPT_OSS],
  [MODEL_QWEN_36]: [MODEL_QWEN_38, MODEL_QWEN_35, MODEL_MINISTRAL, MODEL_GPT_OSS],
  [MODEL_QWEN_35]: [MODEL_QWEN_36, MODEL_QWEN_38, MODEL_MINISTRAL],
};
