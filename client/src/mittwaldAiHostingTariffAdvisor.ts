...
export function formatMittwaldAiHostingTariffAdvisorContext(
  ...
  return (
    ...
    `Bei Tarifbuchung: Tarifseite ${MITTWALD_AI_HOSTING_TARIFF_URL} · mStudio ${MITTWALD_MSTUDIO_URL} (kostenlos anmelden) · API-Keys im mStudio · Vertrieb: ${MITTWALD_TARIF_CONSULT_PHONE} · ${MITTWALD_SALES_URL} · Support: https://www.mittwald.de/darum-mittwald/kundenservice\n\n` +
